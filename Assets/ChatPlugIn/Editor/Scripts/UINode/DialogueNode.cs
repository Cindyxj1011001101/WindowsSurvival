...
namespace ChatPlugIn
{
    ...
    public class DialogueNode:SingleInSingleOutNode
    {
        ...
        protected override void DrawExtensionContainer()
        {
            ...
            {
                ChatData sentenceData = new ChatData();
                ChatDatas.Add(sentenceData);
            ...
            {
                VisualElement lineContainer = CreateSentenceData(chatData);
                foldout.Add(lineContainer);
            }
        ...
        {
            ChatData sentenceData = userData as ChatData;
