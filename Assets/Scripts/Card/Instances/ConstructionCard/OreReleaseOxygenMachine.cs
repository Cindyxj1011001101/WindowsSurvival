...
public class OreReleaseOxygenMachine : ConstructionCard
{
    ...
    private void GenerateOxygen()
    {
        ...
        {
            Debug.LogWarning("矿石释氧机未开启，无法制氧。");
            return;
        }
        ...
        {
            Debug.Log($"矿石释氧机进度{curTimeProgress}/{maxTimeProgress}，无法制氧。");
            return;
        }
