...
public class CaughtAquariusFish : Card
{
    public CaughtAquariusFish()
    {
        ...
        components = new()
        {
            ...
            { typeof(ProgressComponent), new ProgressComponent(5760, 1, null, null) },
        };
    }

    public CaughtAquariusFish(int progress, int productNum) : this()
    {
    ...
    public void Event_Release()
    {
        ...
        // 地点中增加一个水瓶鱼
        TryGetComponent<ProgressComponent>(out var component);
        GameManager.Instance.AddCard(new AquariusFish(component.progress, component.productNum), false);
    }
