...
public class StateManager : IManager
{
    ...
    private State InitHungerState()
    {
        ...
        var lowDangerLevels = new List<int>() { 2 };
        var highDangerLevels = new List<int>() { 0, 1 };
        return new State(100, 250, -1f, thresholds, effects, lowDangerLevels, highDangerLevels, higherIsBetter: true, isDecreaseNatural: true);
    }
    ...
    private State InitHydrationState()
    {
        ...
        var lowDangerLevels = new List<int>() { 2 };
        var highDangerLevels = new List<int>() { 0, 1 };
        return new State(100, 200, -1.3f, thresholds, effects, lowDangerLevels, highDangerLevels, higherIsBetter: true, isDecreaseNatural: true);
    }
    ...
    private State InitSobriety()
    {
        ...
        var lowDangerLevels = new List<int>() { 2 };
        var highDangerLevels = new List<int>() { 0, 1 };
        return new State(150, 180, -1, thresholds, effects, lowDangerLevels, highDangerLevels, higherIsBetter: true, isDecreaseNatural: true);
    }
