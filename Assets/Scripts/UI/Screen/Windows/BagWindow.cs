...
public abstract class BagWindow : WindowBase
{
    ...
    protected override void Awake()
    {
        ...
        slotContainer = transform.Find("BagScrollView/Viewport/Container") as RectTransform;
    ...
    protected void AddSlot(int amount = 1)
    {
    ...
    protected abstract void RecordRuntimeData();
}